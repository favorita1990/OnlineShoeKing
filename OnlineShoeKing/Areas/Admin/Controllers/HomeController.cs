    ...
    public class HomeController : BaseController
    {
        ...
        public JsonResult EditHomePagePicture()
        {
            if (Request.Files.Count > 0)
            {
                ...
                //var physicalPathMainProduct = Path.Combine(Server.MapPath(Resources.Pictures.HomePageImage), fileName);
                //file.SaveAs(physicalPathMainProduct);
        ...
        {
            var controller = "/Admin/Home/Index";
            var controllerName = "Home";
            var controllerPartial = "/Admin/Home/IndexPartial";
