    ...
    public class ProductsController : Controller
    {
        ...
        public ActionResult Product(int? id)
        {
            if (id != null)
            {
                ...
                if (product != null)
                {
                    ...
                    {
                        controller = "/Admin/Products/Men";
                        controllerName = Resources.Language.Men;
                        controllerPartial = "/Founder/Products/MenPartial";
                    }
                    else
                    {
                        controller = "/Admin/Products/Women";
                        controllerName = Resources.Language.Women;
                        controllerPartial = "/Admin/Products/WomenPartial";
                    }

                    var action = $"/Admin/Products/Category/{productViewModel.CategoryId}";
                    var actionName = Resources.Language.CategoryTitle;
                    var actionPartial = $"/Admin/Products/CategoryPartial";
        ...
        public ActionResult _Product(int productId)
        {
            ...
            if ((bool)productViewModel.CategoryGender)
            {
                controller = "/Admin/Products/Men";
                controllerName = Resources.Language.Men;
                controllerPartial = "/Admin/Products/MenPartial";
            }
            else
            {
                controller = "/Admin/Products/Women";
