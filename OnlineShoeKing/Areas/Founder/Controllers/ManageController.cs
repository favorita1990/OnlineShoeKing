...
namespace OnlineShoeKing.Areas.Founder.Controllers
{
    ...
    public class ManageController : Controller
    {
        ...
        {
            var controller = "/Founder/Manage/Index";
            var controllerName = Resources.Language.Settings;
            var controllerPartial = "/Founder/Manage/IndexPartial";
        ...
        public async Task<ActionResult> ChangePassword(ChangePasswordViewModel model)
        {
            ...
            {
                var controller1 = "/Founder/Manage/Index";
                var controllerName2 = Resources.Language.Settings;
                var controllerPartial3 = "/Founder/Manage/IndexPartial";
